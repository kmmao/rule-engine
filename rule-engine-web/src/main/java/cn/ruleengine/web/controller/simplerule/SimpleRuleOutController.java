...
public class SimpleRuleOutController {


    @Resource
    private SimpleRuleOutService ruleOutService;
    ...
    public BaseResult isExists(@RequestBody @Valid IsExistsSimpleRuleRequest isExistsRuleRequest) {
