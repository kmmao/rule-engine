...
@Api(tags = "规则测试控制器")
@RestController
@RequestMapping("ruleEngine/simpleRuleTest")
public class SimpleRuleTestController {

    @Resource
    private SimpleRuleTestService ruleTestService;
     ...
     * @return result
     */
    @DataPermission(id = "#runTestRequest.id", dataType = DataPermissionType.SIMPLE_RULE, type = PermissionType.VALID_WORKSPACE)
    @PostMapping("run")
    @ApiOperation("模拟运行")
