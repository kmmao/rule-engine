...
import cn.ruleengine.web.service.simplerule.SimpleRuleOutService;
import cn.ruleengine.web.vo.simplerule.BatchExecuteRuleRequest;
import cn.ruleengine.web.vo.simplerule.BatchExecuteRuleResponse;
import cn.ruleengine.web.vo.simplerule.ExecuteRuleRequest;
import cn.ruleengine.web.vo.simplerule.IsExistsSimpleRuleRequest;
...
@Slf4j
@Service
public class SimpleRuleOutServiceImpl implements SimpleRuleOutService {
    ...
    public Object batchExecuteRule(BatchExecuteRuleRequest batchExecuteRuleRequest) {
        ...
        for (int fromIndex = 0; fromIndex < executeInfos.size(); fromIndex += threadSegNumber) {
            ...
            BatchExecuteSimpleRuleTask batchExecuteRuleTask = new BatchExecuteSimpleRuleTask(workspaceCode, countDownLatch, outPuts, engine, infoList);
     ...
     */
    @Override
    public Boolean isExists(IsExistsSimpleRuleRequest isExistsRuleRequest) {
