 ...
 */
@Slf4j
public class BatchExecuteSimpleRuleTask implements Runnable {
    ...
    public BatchExecuteSimpleRuleTask(String workspaceCode, CountDownLatch countDownLatch, List<BatchExecuteRuleResponse> outPuts, Engine engine, List<BatchExecuteRuleRequest.ExecuteInfo> infoList) {
