...
@Slf4j
@Component
public class SimpleRuleMessageListener {

    @Resource
    private SimpleRuleEngine defaultEngine;
    @Resource
    ...
    public void message(RuleMessageBody ruleMessageBody) {
        ...
        switch (ruleMessageBody.getType()) {
            case UPDATE:
                ...
                this.defaultEngine.addSimpleRule(rulePublishService.getPublishSimpleRule(workspaceCode, ruleCode));
                break;
            case LOAD:
            ...
            case REMOVE:
                ...
                this.defaultEngine.removeSimpleRule(workspaceCode, ruleCode);
                break;
            default:
